...
<body>
    ...
    <div class="area-result">
        <ul><h5>Total de Chamados: <span id="total-chamados"></span></h5></ul>
        <ul><h5>Chamados aceitos: <span id="aceitos"></span></h5></ul>
        <ul><h5>Chamados recusados: <span id="recusados"></span></h5></ul>
        <ul><h5>Prioridade baixa: <span id="prioridade-baixa"></span></h5></ul>
        <ul><h5>Prioridade média: <span id="prioridade-media"></span></h5></ul>
        <ul><h5>Prioridade alta: <span id="prioridade-alta"></span></h5></ul>
    </div>
...
$(document).ready(function() {
    ...
    function updateTotals() {
        ...
        var aceitos = $('#table-body tr:visible td:contains("aceito")').length;
        var recusados = $('#table-body tr:visible td:contains("recusado")').length;
        var prioridadeBaixa = $('#table-body tr:visible td:contains("baixa")').length;
        var prioridadeMedia = $('#table-body tr:visible td:contains("média")').length;
        var prioridadeAlta = $('#table-body tr:visible td:contains("alta")').length;
