...
<body>
    ...
    <h1 id="txt-titulo">Relatório de Os's</h1>
    <div class="chart-container">
        <canvas id="pieChart"></canvas>
    </div>
    <script>
        // Dados do PHP para JavaScript
        var respondidos = <?php echo $respondidos; ?>;
        var finalizado = <?php echo $finalizado; ?>;
        var naovisto = <?php echo $naovisto; ?>;
        ...
        var pieChart = new Chart(ctx, {
            type: 'pie',
            data: {
                labels: ['Finalizados', 'respondidos', 'naovisto'],
                datasets: [{
                    label: 'Chamados',
                    data: [finalizado, respondidos, naovisto],
