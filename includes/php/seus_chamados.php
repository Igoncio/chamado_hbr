...
foreach ($dados as $user) {
    ...
    if ($user['prioridade'] == "baixa" and $user['status'] == "nao_visto" and $user['id_user'] == $objUsuario->id_user)
        $user_lista .= '   
    <div class="card1">
    ...
    if ($user['prioridade'] == "media" and $user['status'] == "nao_visto" and $user['solicitante'] == $objUsuario->id_user)
        ...
        if ($user['prioridade'] == "media" and $user['status'] == "nao_visto" and $user['id_user'] == $objUsuario->id_user)
        $user_lista .= '   
            <div class="card3">
            <div class="notiglow3"></div>
            <div class="notiborderglow3"></div>
...
if ($user['prioridade'] == "alta" and $user['status'] == "nao_visto" and $user['id_user'] == $objUsuario->id_user)
        $user_lista .= '   
            <div class="card2">
            <div class="notiglow2"></div>
            <div class="notiborderglow2"></div>
...
';
    ...
    if ($user['status'] == "nao_visto" and $user['id_user'] == $objUsuario->id_user) {
        // Limita a descrição para 140 caracteres
        $descricao = (!empty($user['descricao']) ? (strlen($user['descricao']) > 140 ? substr($user['descricao'], 0, 140) . '...' : $user['descricao']) : 'campo vazio');
